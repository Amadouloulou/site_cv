...
if(isset($_POST['titre_e'])){// par le nom du premier input
    ...
    $pdoCV->query("UPDATE t_experiences SET titre_e='$titre_e',sous_titre_e='$sous_titre_e',dates_e='$dates_e',description_e='$description_e'  WHERE id_experience='$id_experience'");
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <section id="about" class="about-section">
        <div class="container">
            <div class="row">
                <h1>Mise à jour d'une experience</h1>
                <div class="col-lg"></div>
                    ...
                    <div class="table-responsive">
                        <form class="" action="modif_experience.php" method="post">
							...
							<label for="sous_titre_e">Formulaire de mise à jour du sous_titre</label>
                            <input type="text" name="sous_titre_e" class="form-control" value="<?php echo $ligne_experience['sous_titre_e']; ?>">

							<label for="dates_e">Formulaire de mise à jour de l'année</label>
                            <input type="text" name="dates_e" class="form-control" value="<?php echo $ligne_experience['dates_e']; ?>">

							<label for="description_e">Formulaire de mise à jour de la description</label>
