...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["Je vis à Pierrefitte-sur-Seine.", "J'aime le numérique.", "Je suis un développeur/intégrateur Web Junior."], /* You can change the home section typing text from
